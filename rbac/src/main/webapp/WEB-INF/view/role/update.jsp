		...
		<form action="" method="post" id="updateRoleForm">
			<table border="0" cellspacing="0" cellpadding="0" class="edit_table">
				...
				<tr>
					...
					<td><input type="text" name="role_name" id="roleName" class="wd200" value="${role.role_name }" />
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="remark" id="username" class=" wd200" value="${role.remark }" />
					</td>
				</tr>
				<tr>
					<th colspan="2" style="text-align:center;padding:2px 0;"><a
						id="submit_add" href="javascript:void(0)" class="easyui-linkbutton"
						data-options="iconCls:'icon-ok'" onclick="updateRole()">确定</a></th>
				</tr>
			</table>
		</form>
	</div>
